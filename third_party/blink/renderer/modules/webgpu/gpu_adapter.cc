...
#include "third_party/blink/renderer/modules/webgpu/gpu_adapter_fp.h"
...
ScriptPromise GPUAdapter::requestAdapterInfo(
  ...
  adapter_info = fpRequestAdapterInfo(adapter_info,RuntimeEnabledFeatures::WebGPUDeveloperFeaturesEnabled());
