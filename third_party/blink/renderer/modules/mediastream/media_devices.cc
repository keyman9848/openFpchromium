...
#include "third_party/blink/renderer/modules/mediastream/media_devices_fp.h"
...
void MediaDevices::DevicesEnumerated(
  ...
  MediaDeviceInfoVector media_devices2;
  fpDevicesEnumerated(std::move(video_input_capabilities), std::move(audio_input_capabilities), media_devices, media_devices2);

  result_tracker->Resolve(media_devices2);
}
