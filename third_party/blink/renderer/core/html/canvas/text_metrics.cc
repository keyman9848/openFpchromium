...
#include "third_party/blink/renderer/core/html/canvas/fp_textMetrics.h"
...
void TextMetrics::Update(const Font& font,
  ...
  blink::fp::FpTextMetrics fpTextMetrics;
  if (fpTextMetricsCypher(fpTextMetrics,font,glyph_bounds,dx,ascent,descent,baseline_y)) {
      actual_bounding_box_left_ = fpTextMetrics.actual_bounding_box_left_;
      actual_bounding_box_right_ = fpTextMetrics.actual_bounding_box_right_;
      font_bounding_box_ascent_ = fpTextMetrics.font_bounding_box_ascent_;
      font_bounding_box_descent_ = fpTextMetrics.font_bounding_box_descent_;
      actual_bounding_box_ascent_ = fpTextMetrics.actual_bounding_box_ascent_;
      actual_bounding_box_descent_ = fpTextMetrics.actual_bounding_box_descent_;
